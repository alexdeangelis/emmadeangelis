...
function emma_scripts() {
	...
	/*Basic Styles*/
	wp_enqueue_style( 'style', get_template_directory_uri() . '/dist/style.css', array(), '1.0.6' );
    /*JS*/
    wp_enqueue_script('theme-js', get_template_directory_uri() . '/dist/theme.bundle.js', array(), '1.0.6', true);
}
